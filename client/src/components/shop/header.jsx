...
function HeaderRightContent() {
    ...
    return (
        <div className="flex mt-5 lg:mt-0 lg:items-center lg:flex-row flex-col gap-4">
            <Sheet open={openCartSheet} onOpenChange={() => setOpenCartSheet(false)}>
                ...
                >
                    ...
                    <Badge
                        className={'absolute top-[-10px] right-[-10px] bg-red-500 hover:bg-red-600 px-1.5'}
                    >
                    ...
                    <div>
                        <Sheet open={openCartSheet} onOpenChange={() => setOpenCartSheet(false)}>
                            ...
                            >
                                ...
                                <Badge
                                    className={
                                        'absolute top-[-10px] right-[-10px] bg-red-500 hover:bg-red-600 px-1.5'
                                    }
                                >
                                    {cartItems?.reduce((totalItems, item) => {
                                        return totalItems + item.quantity;
